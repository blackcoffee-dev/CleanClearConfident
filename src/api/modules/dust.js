...
const getUri = (lat, lng) =>
  `http://openapi.airkorea.or.kr/openapi/services/rest/MsrstnInfoInqireSvc/getNearbyMsrstnList?tmX=${lat}&tmY=${lng}&ServiceKey=${KEY}&_returnType=json`;
// FIXME 임시 사용하지 않는 함수여서
console.log(getUri);
